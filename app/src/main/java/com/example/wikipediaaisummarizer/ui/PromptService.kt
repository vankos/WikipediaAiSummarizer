...
class PromptService {
    ...
    val promptTemplate : String  =
            ...
            "You may include documented interpretations by historians, journalists, economists, and official reports (for example “according to X report…” or “many researchers argue that…”), as long as you present them as interpretations, not absolute truth.\n" +
